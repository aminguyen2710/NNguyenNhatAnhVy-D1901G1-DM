...
if( ! defined( 'SPA_AND_SALON_THEME_VERSION' ) ) define ( 'SPA_AND_SALON_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'SPA_AND_SALON_THEME_NAME' ) ) define( 'SPA_AND_SALON_THEME_NAME', $theme_data->get( 'Name' ) );
if( ! defined( 'SPA_AND_SALON_THEME_TEXTDOMAIN' ) ) define( 'SPA_AND_SALON_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'spa-and-salon' ), $name ) ; ?></p>
...
if( ! function_exists( 'spa_and_salon_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function spa_and_salon_restore_admin_notice(){
    update_option( 'spa_and_salon_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'spa_and_salon_restore_admin_notice' );
