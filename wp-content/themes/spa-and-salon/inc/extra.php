...
function spa_and_salon_change_comment_form_default_fields( $fields ){    
   ...
   $fields['author'] = '<p class="comment-form-author"><label class="screen-reader-text" for="author">' . esc_html__( 'Name*', 'spa-and-salon' ) . '</label><input id="author" name="author" placeholder="' . esc_attr__( 'Name*', 'spa-and-salon' ) . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>';
   
   $fields['email'] = '<p class="comment-form-email"><label class="screen-reader-text" for="email">' . esc_html__( 'Email*', 'spa-and-salon' ) . '</label><input id="email" name="email" placeholder="' . esc_attr__( 'Email*', 'spa-and-salon' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';
...
function spa_and_salon_change_comment_form_defaults( $fields ){
   ...
   $fields['comment'] = '<p class="comment-form-comment"><label class="screen-reader-text" for="comment">' . esc_html__( 'Comment', 'spa-and-salon' ) . '</label><textarea id="comment" name="comment" cols="40" rows="8" required="required" placeholder="' . esc_attr__( 'Comment','spa-and-salon' ) . '"></textarea></p>';;
