...
function fluid_magazine_scripts() {
	...
	wp_enqueue_script( 'owl-carousel-aria', get_template_directory_uri() . '/js/owl.carousel.aria.js', array('owl-carousel'), '2.0.0', true );
...
function fluid_magazine_commentd_fields( $fields ) {
    ...
    $fields['author'] = '<p class="comment-form-author"><label class="screen-reader-text" for="author">' . esc_html__( 'Name*', 'fluid-magazine' ) . '</label><input id="author" name="author" placeholder="' . esc_attr__( 'Name*', 'fluid-magazine' ) . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $aria_req . ' />';    
    $fields['email'] = '<p class="comment-form-email"><label class="screen-reader-text" for="email">' . esc_html__( 'Email*', 'fluid-magazine' ) . '</label><input id="email" name="email" placeholder="' . esc_attr__( 'Email*', 'fluid-magazine' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';
...
function fluid_magazine_change_comment_form( $defaults ) {
    ...
    $defaults['comment_field'] =  '<p class="comment-form-comment"><label class="screen-reader-text" for="comment">' . esc_html__( 'Comment', 'fluid-magazine' ) . '</label><textarea id="comment" name="comment" placeholder="' . esc_attr__( 'Comment', 'fluid-magazine' ) . '" cols="45" rows="8" aria-required="true">' . '</textarea></p>';
